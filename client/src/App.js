...
class App extends Component {
  state = { loaded: false, kycAddress: "0xf30d434A3745aA797Be9d6CA396bcbf1D7D77309", tokenSaleAddress: null, userTokens: 0 };
  ...
  handleMoABCTokensPurchase = async () => {
    await this.TokenSaleInstance.methods.buyTokens(this.accounts[0]).send({ from: this.accounts[0], value: this.web3.utils.toWei("1000", "wei") })
      ;
  }
